        ...
        <div className={styles.querygen}>
            ...
            <div className={styles.qrygen}>
                ...
                <form className={styles.quoteform} id="myForm1">
                    ...
                    <input className={styles.text} type="text" placeholder="insurance type" name="quotinsurance" id="quotinsurance" />
                    ...
                    <input className={styles.text} className={styles.text} type="text" placeholder="age" name="quotage" id="quotage" />
