        ...
        <div className={styles.writequery}>
            <div className={`${styles.qrygen} ${styles.qrygen1}`}>
                ...
                <form id="myForm" className={styles.quoteform}>
                    <input className={styles.text} type="text" placeholder="Name" name="name" id="quotnam1" required />
                    ...
                    <textarea className={styles.textarea} name="review" id="queryy" cols="3" rows="4" placeholder="Write your review"></textarea>
